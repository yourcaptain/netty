...
public class SniClientTest {
    ...
    public void testSniSNIMatcherNotMatchesClientJdkSslServerJdkSsl() throws Exception {
        Assume.assumeTrue(PlatformDependent.javaVersion() >= 8);
    ...
    @Test(timeout = 30000, expected = ClosedChannelException.class)
    public void testSniSNIMatcherNotMatchesClientOpenSslServerOpenSsl() throws Exception {
        Assume.assumeTrue(PlatformDependent.javaVersion() >= 8);
        Assume.assumeTrue(OpenSsl.isAvailable());
    ...
    @Test(timeout = 30000, expected = ClosedChannelException.class)
    public void testSniSNIMatcherNotMatchesClientJdkSslServerOpenSsl() throws Exception {
        Assume.assumeTrue(PlatformDependent.javaVersion() >= 8);
        Assume.assumeTrue(OpenSsl.isAvailable());
    ...
    @Test(timeout = 30000, expected = ClosedChannelException.class)
    public void testSniSNIMatcherNotMatcheslientOpenSslServerJdkSsl() throws Exception {
        Assume.assumeTrue(PlatformDependent.javaVersion() >= 8);
        Assume.assumeTrue(OpenSsl.isAvailable());
